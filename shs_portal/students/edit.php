...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($photo_data) {
        ...
        $update_student = "UPDATE students SET 
            ...
            class_id=$5, admission_date=$6, address=$7, phone=$8, email=$9,department_id =$10, photo=decode($11, 'hex')
            WHERE student_id=$12";
        $res_student = pg_query_params($conn, $update_student, [
            $first_name, $last_name, $gender, $dob, $class_id, $admission_date, $address, $phone, $email,$department_id, $photo_hex, $id
        ]);
    } else {
        $update_student = "UPDATE students SET 
            first_name=$1, last_name=$2, gender=$3, date_of_birth=$4,
            class_id=$5, admission_date=$6, address=$7, phone=$8, email=$9,department_id =$10
            WHERE student_id=$11";
        $res_student = pg_query_params($conn, $update_student, [
            $first_name, $last_name, $gender, $dob, $class_id, $admission_date, $address, $phone, $email,$department_id, $id
        ]);
    }
